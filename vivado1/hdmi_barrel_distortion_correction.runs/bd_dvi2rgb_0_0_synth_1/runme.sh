...
HD_PWD='D:/work/vivado/pynq/hdmi_io/hdmi_io.runs/bd_dvi2rgb_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_dvi2rgb_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_dvi2rgb_0_0.tcl
